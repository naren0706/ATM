...
*/
    ...
    private static void checkBalance() {
        ...
        if((userNamePassword.get(inputUserName)).equals(inputUserPassword) )
        {
            System.out.println("your balance is :"+userNameBalance.get(inputUserName));
        }
        else
        {
            System.out.println("Try again,Invalid User name or Password");
    ...
    private static void updateAmount(String inputUserName) {

        int deposit = 0;
        System.out.println("Allowed denominations are 2000,500,200,100");
        System.out.println("enter the number of 2000.Rs");
        int towThousand = sc.nextInt();
        System.out.println("enter the number of 500.Rs");
        int fiveHundred = sc.nextInt();
        System.out.println("enter the number of 200.Rs");
        int towHundred = sc.nextInt();
        System.out.println("enter the number of 100.Rs");
        int hundred = sc.nextInt();

        deposit = towThousand*2000 + fiveHundred*500 + towHundred*200 + hundred*100 ;
        int n = userNameBalance.get(inputUserName);
        n+=deposit;
        userNameBalance.put(inputUserName,n);
        int number = towThousand+fiveHundred+towHundred+hundred;
        System.out.println("the amount deposited :"+deposit);
        System.out.println("Total Number of money deposited :"+number);
    ...
    private static void reduceAmount(String inputUserName) {
        System.out.println("enter the amount:");
        int withdraw = sc.nextInt();
        int balance = userNameBalance.get(inputUserName);
        if(balance>withdraw)
        {
            balance-=withdraw;
        }
        ...
        userNameBalance.put(inputUserName,balance);
        
        System.out.println("Amount withDrawled is Rs."+balance);
    }
